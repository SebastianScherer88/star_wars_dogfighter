...
class LaserCannon(object):
    ...
    def __init__(self,
        ...
        Arguments:
            ...
            at firing time.
            - weapon_fire_rate: rate of fire for this laser weapon, in shots/second
            - weapon_offset: 2-dim offset vector specifying the laser weapon tip w.r.t
            ...
            - weapon_range_in_seconds: how long the laser beam (class MissileSprite object)
            created by this object class at firing time will stay alive in seconds.
            - weapon_speed_in_seconds: the speed of the laser beam in pixel per second
            if shot from a stationary ship sprite.
            - original_laser_images: pygame surface object specifiying the laser beam
        ...
        self._offset = np.array(cannon_offset).reshape(1,2)
    ...
    def get_laser_sprite_positions(self):
        ...
        # rotate offsets so they are aligned with ship sprite's current orientation
        rotated_offset = np.dot(rotation_matrix,
                                self._offset.T).T
        
        # calculate pixel positions of gun muzzles w.r.t main screen's coordinate system
        rotated_position = self._ship._center + rotated_offset
        
        return rotated_offset, rotated_position
    ...
    def fire(self):
        ...
        muzzle_flash_offset, laser_beam_position = self.get_laser_sprite_positions()
        ...
        ProjectileSprite(self._ship._fps,
                     ...
                     speed = self._ship._speed * self._ship._fps + weapon_speed_in_seconds)